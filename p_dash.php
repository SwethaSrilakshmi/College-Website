      ...
      <a href="p_inter.php"> <h3 class="text-primary"><span class="label label-primary pull-right"></span>Internal Marks </h3></a>
       ...
       <div class="col-md-3">
        <div class="well" style="margin-left:20px;margin-top:25px; width:270px; height:170px; text-align:center; background-color:pink; ">
         <a href="https://docs.google.com/document/d/1_TunkHihHRNvuyYEEKupiRDQ3o5rZUcP1PfYVlxJo-w/edit" target="_blank"> <h3 class="text-primary"><span class="label label-primary pull-right"><span class="label label-primary pull-right"></span>View Time Table </h3></a>
        </div>
      </div>
     <div class="col-md-3">
